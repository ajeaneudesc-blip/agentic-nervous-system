# Playbooks — Product Owner / Orchestrator

Référence à lire à la demande (pas par défaut) quand la tâche en cours touche l'un de ces sujets — issus de la bibliothèque ECC (Everything Claude Code), triés pour ce rôle.
